	...
	public void send_location_details_to_email_address() throws InterruptedException, IOException ,Exception
	{
		...
		for (String stagingURL:OpenStreetMapLocatorPage.stagingURL) {
			try {
				...
				try {
					assertEquals(driver.findElement(By.cssSelector("div.modal")).getText(), "Close");
				...
				try {
					assertEquals("EMAIL ADDRESS IS REQUIRED", driver.findElement(By.cssSelector("font")).getText());
					test26.log(LogStatus.PASS, "Pass.");
					System.out.println("Pass");
				} catch (AssertionError e) {
					System.out.println("Fail :"+e.getMessage());
				...
				try {
					assertEquals("INVALID EMAIL ADDRESS", driver.findElement(By.cssSelector("font")).getText());
					test26.log(LogStatus.PASS, "Pass.");
					System.out.println("Pass");
				...
				try {
					assertEquals(driver.findElement(By.cssSelector("div.divmargin.confirmation")).getText(),
							"Confirmation");
					test26.log(LogStatus.PASS, "Pass.");
					System.out.println("Pass");
				...
				try {
					assertTrue(isElementPresent(By.cssSelector("canvas.ol-unselectable")));
					test26.log(LogStatus.PASS, "Pass.");
					System.out.println("Pass");
				} catch (AssertionError e) {
					System.out.println("Fail :"+e.getMessage());
