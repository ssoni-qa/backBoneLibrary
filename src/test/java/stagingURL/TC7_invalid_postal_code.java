	...
	public void valid_postal_code() throws InterruptedException, IOException
	{
		...
		for (String stagingURL:OpenStreetMapLocatorPage.stagingURL) {
			...
			try {
				...
				try {
					assertEquals(driver.findElement(By.cssSelector("p")).getText(), "You entered an address which could not be geocoded [ 0123456789 US ]. Please try another input address to search for locations.");
