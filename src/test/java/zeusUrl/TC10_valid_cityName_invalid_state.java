	...
	public void valid_cityName_invalid_state() throws InterruptedException, IOException
	{
		...
		for (String zeusUrl:OpenStreetMapLocatorPage.zeusUrl) {
			...
			try {
				...
				test10.log(LogStatus.INFO, "Zeus Url :"+zeusUrl);
				...
				try {
					AssertJUnit.assertEquals(driver.findElement(By.cssSelector("strong")).getText(), "Anaheim Coach & Trailer RV Storage Anaheim");
