	...
	public void verify_regionalmap_presented_on_page_load() throws InterruptedException, IOException,Exception
	{
		...
		for (String zeusUrl:OpenStreetMapLocatorPage.zeusUrl) {
			...
			try {
				...
				test2.log(LogStatus.INFO, "Staging URL :"+zeusUrl);
				...
				System.out.println("Staging URL :"+zeusUrl);
				...
				try {
					AssertJUnit.assertEquals(onPage.addressSearch.getAttribute("value"), "Arlington Heights  IL 60006");
					AssertJUnit.assertEquals(selectedCountry.getText(), "United States Of America");
