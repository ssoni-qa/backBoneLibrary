	...
	public void invalid_Street_address_with_valid_CityName_and_valid_StateName() throws InterruptedException, IOException
	{
		...
		for (String zeusUrl:OpenStreetMapLocatorPage.zeusUrl) {
			...
			try {
				...
				test12.log(LogStatus.INFO, "Zeus Url :"+zeusUrl);
				...
				try {
					AssertJUnit.assertEquals(driver.findElement(By.xpath("//li/div[2]/div")).getText(), "Anaheim, CA 92807");					System.out.println("Pass.");
